...
`
		...
		try {
		   ...
		   const reply = (teks) => {
				client.sendMessage(from, teks, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `${ucapanWaktu} ☁`,"body": `DEV MITSUHA : ${date}`,"previewType": "PHOTO","thumbnailUrl": `https://h.top4top.io/p_209728xbs0.png`,"thumbnail": "","sourceUrl": "https://youtube.com/channel/UC-fcNjQQ5LXV50sSV6s2eXg"}},quoted: mek})
			}
...
case 'revoke':
if (!isRegistered) return reply(ind.noregis())     
if (!isGroup) return client.sendMessage(from, `\`\`\`▢ FITUR GROUP ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `© 𝑩𝒀 - 𝑴𝑰𝑻??𝑼𝑯𝑨 𝑩𝑶𝑻𝒁`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://h.top4top.io/p_209728xbs0.png`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
...
case 'setopen':
if (!isRegistered) return reply(ind.noregis())     
if (!isGroup) return client.sendMessage(from, `\`\`\`▢ FITUR GROUP ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `© 𝑩𝒀 - 𝑴??𝑻??𝑼𝑯𝑨 𝑩𝑶𝑻𝒁`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://h.top4top.io/p_209728xbs0.png`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
if (!isGroupAdmins) return client.sendMessage(from, `\`\`\`▢ FITUR ADMIN ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `${ucapanWaktu} ☁`,"body": `DEV MITSUHA : ${date}`,"previewType": "PHOTO","thumbnailUrl": `https://h.top4top.io/p_209728xbs0.png`,"thumbnail": "","sourceUrl": "https://youtube.com/channel/UC-fcNjQQ5LXV50sSV6s2eXg"}},quoted: mek})     
if (!isBotGroupAdmins) return client.sendMessage(from, `\`\`\`▢ BOT HARUS ADMIN ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `${ucapanWaktu} ☁`,"body": `DEV MITSUHA : ${date}`,"previewType": "PHOTO","thumbnailUrl": `https://h.top4top.io/p_209728xbs0.png`,"thumbnail": "","sourceUrl": "https://youtube.com/channel/UC-fcNjQQ5LXV50sSV6s2eXg"}},quoted: mek})
...
if (!isGroup) return client.sendMessage(from, `\`\`\`▢ FITUR GROUP ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `${ucapanWaktu} ☁`,"body": `DEV MITSUHA : ${date}`,"previewType": "PHOTO","thumbnailUrl": `https://h.top4top.io/p_209728xbs0.png`,"thumbnail": "","sourceUrl": "https://youtube.com/channel/UC-fcNjQQ5LXV50sSV6s2eXg"}},quoted: mek})
if (!isGroupAdmins) return client.sendMessage(from, `\`\`\`▢ FITUR ADMIN ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `${ucapanWaktu} ☁`,"body": `DEV MITSUHA : ${date}`,"previewType": "PHOTO","thumbnailUrl": `https://h.top4top.io/p_209728xbs0.png`,"thumbnail": "","sourceUrl": "https://youtube.com/channel/UC-fcNjQQ5LXV50sSV6s2eXg"}},quoted: mek})     
if (!isBotGroupAdmins) return client.sendMessage(from, `\`\`\`▢ BOT HARUS ADMIN ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `© 𝑩𝒀 - 𝑴??𝑻𝑺𝑼???? ??𝑶𝑻??`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://h.top4top.io/p_209728xbs0.png`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
...
if (!isRegistered) return reply(ind.noregis())     
if (!isGroup) return client.sendMessage(from, `\`\`\`▢ FITUR GROUP ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `${ucapanWaktu} ☁`,"body": `DEV MITSUHA : ${date}`,"previewType": "PHOTO","thumbnailUrl": `https://h.top4top.io/p_209728xbs0.png`,"thumbnail": "","sourceUrl": "https://youtube.com/channel/UC-fcNjQQ5LXV50sSV6s2eXg"}},quoted: mek})
if (!isGroupAdmins) return client.sendMessage(from, `\`\`\`▢ FITUR ADMIN ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `© ??𝒀 - 𝑴𝑰??𝑺𝑼𝑯𝑨 ??𝑶𝑻𝒁`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://h.top4top.io/p_209728xbs0.png`,"thumbnail": "","sourceUrl": ""}},quoted: mek})     
if (!isBotGroupAdmins) return client.sendMessage(from, `\`\`\`▢ BOT HARUS ADMIN ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `${ucapanWaktu} ☁`,"body": `DEV MITSUHA : ${date}`,"previewType": "PHOTO","thumbnailUrl": `https://h.top4top.io/p_209728xbs0.png`,"thumbnail": "","sourceUrl": "https://youtube.com/channel/UC-fcNjQQ5LXV50sSV6s2eXg"}},quoted: mek})
...
if (!isGroup) return client.sendMessage(from, `\`\`\`▢ FITUR GROUP ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `${ucapanWaktu} ☁`,"body": `DEV MITSUHA : ${date}`,"previewType": "PHOTO","thumbnailUrl": `https://h.top4top.io/p_209728xbs0.png`,"thumbnail": "","sourceUrl": "https://youtube.com/channel/UC-fcNjQQ5LXV50sSV6s2eXg"}},quoted: mek})
if (!isGroupAdmins) return client.sendMessage(from, `\`\`\`▢ FITUR ADMIN ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `${ucapanWaktu} ☁`,"body": `DEV MITSUHA : ${date}`,"previewType": "PHOTO","thumbnailUrl": `https://h.top4top.io/p_209728xbs0.png`,"thumbnail": "","sourceUrl": "https://youtube.com/channel/UC-fcNjQQ5LXV50sSV6s2eXg"}},quoted: mek})     
if (!isBotGroupAdmins) return client.sendMessage(from, `\`\`\`▢ BOT HARUS ADMIN ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `© 𝑩𝒀 - ??𝑰𝑻𝑺𝑼𝑯𝑨 𝑩𝑶𝑻𝒁`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://h.top4top.io/p_209728xbs0.png`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
...
client.sendMessage('62857312617281@s.whatsapp.net', options, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `© 𝑩𝒀 - 𝑴𝑰𝑻??𝑼𝑯𝑨 𝑩????𝒁`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://h.top4top.io/p_209728xbs0.png`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
...
client.updatePresence(from, Presence.composing) 
if (!isRegistered) return reply(ind.noregis())   
if (!isGroup) return client.sendMessage(from, `\`\`\`▢ FITUR GROUP ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `?? LIVE!! JANGAN LUPA SUBSCRIBE CHANEL Mitsuha_Chan YA!!`,"body": `DEV MITSUHA : ${date}`,"previewType": "PHOTO","thumbnailUrl": `https://h.top4top.io/p_209728xbs0.png`,"thumbnail": "","sourceUrl": "https://youtube.com/channel/UC-fcNjQQ5LXV50sSV6s2eXg"}},quoted: mek})  
absen.push(sender)
...
case 'anlytis':
if (!isRegistered) return reply(ind.noregis())
batre = [`[_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅]`,`[_̲̅_̲̅_̲̅]`,`[_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅]`,`[_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅]`,`[_̲̅_̲̅_̲̅_̲̅_̲̅]`,`[_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅]`,`[_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅]`,`[_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅]`,`[_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅]`,`[_̲̅_̲̅_̲̅_̲_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅_̲̅]`]
const fonts = batre[Math.floor(Math.random() * batre.length)]
const fonts2 = batre[Math.floor(Math.random() * batre.length)]
const fonts3 = batre[Math.floor(Math.random() * batre.length)]
const fonts4 = batre[Math.floor(Math.random() * batre.length)]
reply(`*DATA ANALITIS BOT*\n
VIEWS BLOGGER
${fonts} ${view.length}\n
LIKE KUALITAS
${fonts2} ${like.length}\n
DISLIKE KUALITAS
${fonts3} ${dislike.length}\n
FOLLOWERS POSTING
${fonts4} ${love.length}`)
break
...
client.sendMessage(from, opp, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `${ucapanWaktu} ☁`,"body": `DEV MITSUHA : ${date}`,"previewType": "PHOTO","thumbnailUrl": `https://h.top4top.io/p_209728xbs0.png`,"thumbnail": "","sourceUrl": ""}},quoted: mek2})  
break
}*/
...
if (buttonsR === 'Tutup') {
	  if (!isRegistered) return reply(ind.noregis())     
					...
					if (!isGroupAdmins) return client.sendMessage(from, `\`\`\`▢ FITUR ADMIN ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `© 𝑩?? - 𝑴??𝑻𝑺𝑼𝑯𝑨 𝑩𝑶𝑻𝒁`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://h.top4top.io/p_209728xbs0.png`,"thumbnail": "","sourceUrl": ""}},quoted: mek})     
					if (!isBotGroupAdmins) return client.sendMessage(from, `\`\`\`▢ BOT HARUS ADMIN ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `${ucapanWaktu} ☁`,"body": `DEV MITSUHA : ${date}`,"previewType": "PHOTO","thumbnailUrl": `https://h.top4top.io/p_209728xbs0.png`,"thumbnail": "","sourceUrl": "https://youtube.com/channel/UC-fcNjQQ5LXV50sSV6s2eXg"}},quoted: mek})
	var nomor = mek.participant
              const close = {
              text: `Grup ditutup oleh admin @${nomor.split("@s.whatsapp.net")[0]}\nsekarang *hanya admin* yang dapat mengirim pesan`,
...
if (buttonsR === '10 menit') {
              if (!isRegistered) return reply(ind.noregis())     
              if (!isGroup) return client.sendMessage(from, `\`\`\`▢ FITUR GROUP ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `${ucapanWaktu} ☁`,"body": `DEV MITSUHA : ${date}`,"previewType": "PHOTO","thumbnailUrl": `https://h.top4top.io/p_209728xbs0.png`,"thumbnail": "","sourceUrl": "https://youtube.com/channel/UC-fcNjQQ5LXV50sSV6s2eXg"}},quoted: mek})
              if (!isGroupAdmins) return client.sendMessage(from, `\`\`\`▢ FITUR ADMIN ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `𖥻˖ֹMITSUHA BOTx || OFCʾ˖??`,"body": `Official Mitsuhabot Whatsapp`,"previewType": "PHOTO","thumbnailUrl": `https://h.top4top.io/p_209728xbs0.png`,"thumbnail": "","sourceUrl": ""}},quoted: mek})     
			  if (!isBotGroupAdmins) return client.sendMessage(from, `\`\`\`▢ BOT HARUS ADMIN ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `${ucapanWaktu} ☁`,"body": `DEV MITSUHA : ${date}`,"previewType": "PHOTO","thumbnailUrl": `https://h.top4top.io/p_209728xbs0.png`,"thumbnail": "","sourceUrl": "https://youtube.com/channel/UC-fcNjQQ5LXV50sSV6s2eXg"}},quoted: mek})
			setTimeout( () => {
				client.groupSettingChange (from, GroupSettingChange.messageSend, true);
				}, 600000)
...
if (hoour_now >= '11:25' && hour_now <= '11:25') {
var ini = benar.indexOf(from)
benar.splice(ini, 1)
fs.writeFileSync('./src/benar.json', JSON.stringify(benar))
var ini = salah.indexOf(from)
salah.splice(ini, 1)
...
buttons = [{buttonId:`BLOGGER`,buttonText:{displayText:'BLOGGER'},type:1}]
imageMsg = ( await client.prepareMessage(from, fs.readFileSync(`./lib/draft.jpg`),'imageMessage', {thumbnail: Buffer.alloc(0)})).message.imageMessage
buttonsMessage = {footerText:`*${randKey.pushname}*\n\n${randKey.teks}`, imageMessage: imageMsg,
contentText:`view ${view.length}`,buttons,headerType:4}
prep = await client.prepareMessageFromContent(from,{buttonsMessage}, {quoted: falfa})
client.relayWAMessage(prep)
break
}
