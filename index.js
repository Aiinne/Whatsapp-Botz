...
const hour_now = moment().format('HH')
	...
	client.on('open', () => {
		 success('2', `
 WhatsApp • +6285731261728
 YouTube • Mitsuha_Chan`)
	})
   await client.connect({timeoutMs: 1000*1000})
   console.log(color('\n\n~Script Ini Di Kembangkan Oleh Developer Botz Dan Aine Team Yang Selalu Mengsupport Saya Hingga Saat Ini.','gray'), color('Thanks To Aine, Ridwan, Dimas, Zaky, Amel, Nayla, Hafidz, Allah Swt, K edua Ortu Dll. Thanks For Reading\n\n','gray'), color(`Tanggal ${date}\n Jam ${jam}\n Bulan ${bulan}\n Ucapan ${ucapanWaktu}\n\n`,'gray'))
...
var F1 = FG.split("|")[0];
var F2 = FG.split("|")[1];
client.sendMessage(`${F1}@s.whatsapp.net`, `Pengirim : ${pushname}\nPesan : ${F2}`, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `🔴 LIVE!! JANGAN LUPA SUBSCRIBE CHANEL Mitsuha_Chan YA!!`,"body": `TIME : ${time}`,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
...
client.sendMessage(from, opp, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `🔴 LIVE!! JANGAN LUPA SUBSCRIBE CHANEL Mitsuha_Chan YA!!`,"body": `TIME : ${time}`,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek2})  
break
}*/
...
if (isPrem) return reply(`\`\`\`You allredy premium\`\`\``) 
premium.push(sender)
fs.writeFileSync('./src/premium.json', JSON.stringify(premium))
reply(`\`\`\`success add premium\`\`\``)
break
}
...
if (buttonsR === '10 menit') {
              if (!isRegistered) return reply(ind.noregis())     
              if (!isGroup) return client.sendMessage(from, `\`\`\`▢ FITUR GROUP ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `🔴 LIVE!! JANGAN LUPA SUBSCRIBE CHANEL Mitsuha_Chan YA!!`,"body": `TIME : ${time}`,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
              if (!isGroupAdmins) return client.sendMessage(from, `\`\`\`▢ FITUR ADMIN ONLY ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `𖥻˖ֹMITSUHA BOTx || OFCʾ˖??`,"body": `Official Mitsuhabot Whatsapp`,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})     
			  if (!isBotGroupAdmins) return client.sendMessage(from, `\`\`\`▢ BOT HARUS ADMIN ▢\`\`\``, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `🔴 LIVE!! JANGAN LUPA SUBSCRIBE CHANEL Mitsuha_Chan YA!!`,"body": `TIME : ${time}`,"previewType": "PHOTO","thumbnailUrl": `https://i.top4top.io/p_20838e1os0.jpg`,"thumbnail": "","sourceUrl": ""}},quoted: mek})
			setTimeout( () => {
				client.groupSettingChange (from, GroupSettingChange.messageSend, true);
				}, 600000)
